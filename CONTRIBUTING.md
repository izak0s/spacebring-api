...
3. **Facade** — `src/generated/resources/*.ts`, produced by our own generator (`codegen/generate-facade.ts`): nested namespaces, positional path params, `iterate()` pagination, envelope unwrapping.
